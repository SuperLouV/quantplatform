...
.PHONY: ui check events pool-refresh pool-refresh-nasdaq100 daily-refresh daily-refresh-nasdaq100 schedule-install schedule-uninstall schedule-status schedule-plist
