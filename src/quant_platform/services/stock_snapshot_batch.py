    ...
    def create_snapshot_from_quote(
        ...
        *,
        ...
        return StockSnapshot(
            ...
            overnight_price=quote.get("overnight_price"),
            ...
            quote_provider=quote.get("quote_provider") or quote.get("provider"),
            quote_provider_status=quote.get("quote_provider_status"),
